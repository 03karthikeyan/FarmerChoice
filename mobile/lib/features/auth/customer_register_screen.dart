...
class _CustomerRegisterScreenState extends State<CustomerRegisterScreen> {
  ...
  void _submit() async {
    ...
    if (name.isEmpty || phone.isEmpty || pass.isEmpty || village.isEmpty || district.isEmpty) {
    ...
    final ok = await authProvider.registerCustomer(
      name: name,
      phone: phone,
    ...
    if (ok && mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(authProvider.errorMessage.isNotEmpty ? authProvider.errorMessage : 'Registration failed'),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Buy fresh farm vegetables directly from verified farmers.',
                    ...
                    child: Container(
                      ...
                      child: _isUploadingImage
                          ...
                          : _profileImageUrl == null
                              ? const Center(
                                  child: Icon(Icons.person_rounded, size: 54, color: Color(0xFF176B2C)),
                                )
                              : null,
                    ),
                  ),
            ...
            Center(
              child: Text(
                _profileImageUrl != null ? 'Photo selected' : 'Upload Profile Photo (Optional)',
            ...
            _inputField('Mobile Number *', _phoneController, Icons.phone_outlined, keyboard: TextInputType.phone),
            const SizedBox(height: 16),
            _inputField('Email Address (Optional)', _emailController, Icons.email_outlined, keyboard: TextInputType.emailAddress),
            const SizedBox(height: 16),
            ...
            _inputField('Village / Town *', _villageController, Icons.location_city_outlined),
            const SizedBox(height: 16),
